...
dataset_train_kNN = torchvision.datasets.CIFAR10(
    root=path_to_train, train=True, download=True
)
dataset_train_kNN = LightlyDataset.from_torch_dataset(dataset_train_kNN, transform=test_transforms)

# dataset_test = LightlyDataset(input_dir=path_to_test, transform=test_transforms)
dataset_test = torchvision.datasets.CIFAR10(
    root=path_to_test, train=False, download=True
)
dataset_test = LightlyDataset.from_torch_dataset(dataset_test, transform=test_transforms)
...
def create_dataset_train_ssl(model):
    ...
    data = torchvision.datasets.CIFAR10(root=path_to_train, train=True, download=True)
    return LightlyDataset.from_torch_dataset(data, transform=transform)
